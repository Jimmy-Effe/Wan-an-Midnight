document.addEventListener("DOMContentLoaded", () => {
  ...
  form.addEventListener("submit", (e) => {
    ...
    if (getNum < generateRandomNum) {
      ...
      // success.textContent = "";
      num.value = "";
      hint.textContent = "Hmmm...,尝试小一点的数字";
      submit.innerText = "重试";
      // success guessed mystery number
    } else {
      main.innerHTML =
        '<span class="message">神秘数字是:</span>';
      success.innerHTML = `你尝试了 <span class="bigger-font">${tries}</span> 次!`;
      hint.textContent = "";
  ...
  reset.addEventListener("click", (e) => {
    ...
    main.textContent = "Choose a number between 1 and 100";

    generateRandomNum = Math.floor(Math.random() * 100) + 1;
    tries = 1;
